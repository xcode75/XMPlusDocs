...
aaPanel  > App Store > PHP 7.4 > Setting > Disabled functions > remove from list ( exec, putenv, proc_open, pcntl_alarm, pcntl_signal, system )。
...
wget https://github.com/xcode75/XManagerPlus/releases/download/v20230131/XMPlus.zip
unzip XMPlus.zip
chmod +x install.sh
./install.sh
```
